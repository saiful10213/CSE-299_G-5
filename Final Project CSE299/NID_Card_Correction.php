<?php
session_start();
require 'db.php'; // Make sure this points to your correct DB connection file
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($_POST['action'] === 'submit_correction') {
...
<div id="correctionPage">
  ...
  <form id="correctionForm">
    ...
    <textarea id="correctedValue" rows="3" required></textarea>
